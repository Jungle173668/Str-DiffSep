...
from espnet2.enh.diffusion.score_based_diffusion_streaming import StreamingScoreModel
from espnet2.enh.layers.SkiMDiff import SkiMDiff_Separator
...
encoder_choices = ClassChoices(
    name="encoder",
    classes=dict(stft=STFTEncoder, conv=ConvEncoder, same=NullEncoder, raw=RawEncoder),
...
decoder_choices = ClassChoices(
    name="decoder",
    classes=dict(stft=STFTDecoder, conv=ConvDecoder, same=NullDecoder, raw=RawDecoder),
...
diffusion_choices = ClassChoices(
    ...
    classes=dict(sgmse=ScoreModel, sgmse_s=StreamingScoreModel),
